<script>
  ...
  import { pets, selectedPet, loading, appState } from '../stores/appState.js';
        ...
        >
          <div class="pet-main">
            <div class="pet-name-row">
              ...
              <div class="pet-actions">
                <button
                  ...
                  on:click={(e) => { e.stopPropagation(); selectPet(pet); }}
            ...
            <div class="pet-species-row">
              <span class="pet-type">{pet.species || 'Unknown'}</span>
            </div>

            <div class="pet-meta">
              {formatKnownGenes(pet.known_genes, pet.has_unknown_genes)} • 📅 {formatDate(pet.created_at)}
            </div>
