...
class DuckLakeGeneDatabase:
    ...
    def _create_tables(self) -> None:
        ...
        Note: users and user_sessions live in a separate SQLite database
        (see auth/database.py) for proper ACID transactions.
        """
    ...
    def delete_pets_for_user(self, user_id: int) -> None:
        """Delete all pets belonging to a user (called when admin deletes a user)."""
        assert self.conn is not None
