...
const fakeBee1 = { id: 1, name: 'Buzzy', species: 'BeeWasp' } as unknown as Pet;
const fakeBee2 = { id: 2, name: 'Stinger', species: 'BeeWasp' } as unknown as Pet;
const fakeHorse = { id: 3, name: 'Thunder', species: 'Horse' } as unknown as Pet;
