...
test('debug: capture pet visualization layout', async ({ page }) => {
  ...
  const dims = await page.evaluate(() => {
    ...
    const results: {
      detailPane?: RectInfo;
      petVisualization?: RectInfo;
      detailContent?: RectInfo;
      visualizerContainer?: RectInfo;
      geneVisualizer?: RectInfo;
      geneSection?: RectInfo;
      geneGridContainer?: RectInfo;
      geneLegend?: RectInfo;
      detailHeader?: RectInfo;
